...
var SearchBar = _reactAddons2["default"].createClass({
  ...
  propTypes: {
    ...
    autosuggestDelay: _reactAddons2["default"].PropTypes.number
  },
  ...
  render: function render() {
    return _reactAddons2["default"].createElement(
      ...
      !!this.state.matches.length && _reactAddons2["default"].createElement(SearchBar.Suggestions, {
...
SearchBar.Suggestions = _reactAddons2["default"].createClass({
